...
В ходе лабораторной работы было успешно разработано REST API для управления спортивными лигами и матчами с использованием Node.js и Express. Реализованы все обязательные требования: CRUD-операции, валидация входных данных с Zod, централизованная обработка ошибок и автоматическая генерация документации через Swagger. API возвращает корректные HTTP статус-коды и предоставляет понятные сообщения об ошибках. Дополнительно реализованы пагинация матчей и версионирование маршрутов. Приложение готово к использованию и демонстрации.
