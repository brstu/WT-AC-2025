# Каталог фильмов - Лабораторная работа 02

## 🎬 О проекте

Интерактивный каталог фильмов с современным интерфейсом, реализованный на чистом JavaScript. Позволяет просматривать фильмы по категориям, изучать детальную информацию и добавлять новые фильмы через валидируемую форму.

![Главный экран каталога](screenshot.jpg)
