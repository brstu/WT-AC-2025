...
Настроить ORM и схему данных (SQLite/PostgreSQL), реализовать регистрацию/логин, выдачу JWT, middleware защиты и доступ к задачам только владельца.

---

### Вариант №25. Планировщик поездок с совместным доступом
