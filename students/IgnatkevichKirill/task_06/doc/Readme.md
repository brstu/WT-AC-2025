...
- `productsController.js` - Контроллеры товаров
- `cartController.js`- Контроллеры корзины
- `ordersController.js` - Контроллеры заказов
- `auth.js`- Middleware аутентификации
- `validate.js` - Валидация данных
- `errorHandler.js`- Обработка ошибок
- `auth.js` - Маршруты аутентификации
- `products.js` - Маршруты товаров
- `cart.js` - Маршуруты карзины
...
| -------------------------------------------------------------------- | ----- | --------- |
| Refresh‑токены и обновление access‑токена.                           | 10    | ✅ / ✅  |
| Роли/права (admin/user).                                             | 10    | ✅ / ✅  |
| Password reset flow (email‑заглушка).                                | 10    | ✅ / ✅  |

---

## Ссылка на публикацию

👉 Вставьте ссылку на GitHub Pages: https://pyrokekw.github.io/WT-LAB6/
