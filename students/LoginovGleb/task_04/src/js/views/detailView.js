                ...
                <div class="card-body">
                    ...
                    <div class="event-meta">
                        <div class="event-meta-item">
                            ...
                            <span><strong>Дата:</strong> ${formatDate(event.date)}</span>
                        </div>
                        ...
                        <div class="event-meta-item">
                            ...
                            <span><strong>Время:</strong> ${escapeHtml(event.time || 'Не указано')}</span>
                        </div>
                        ...
                        <div class="event-meta-item">
                            ...
                            <span><strong>Место:</strong> ${escapeHtml(event.location)}</span>
                        </div>
                        ...
                        <div class="event-meta-item">
                            ...
                            <span><strong>Организатор:</strong> ${escapeHtml(event.organizer || 'Не указан')}</span>
                        </div>
                        ...
                        ${event.maxParticipants ? `
                            <div class="event-meta-item">
                                ...
                                <span><strong>Максимум участников:</strong> ${escapeHtml(event.maxParticipants)}</span>
                            </div>
                        ` : ''}
                    </div>
                    ...
                    <div class="event-actions">
                        <a href="#/items/${event.id}/edit" class="btn btn--primary">
